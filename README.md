# Agent-based Modeling Use Cases Utilizing Geographically-Explicit Synthetic Population
This repository documents agent-based modeling (ABM) applications built on geographically-explicit synthetic population datasets—with core work leveraging the U.S. Census data and open-source tools to enable realistic spatial and social simulation of human behavior and interactions.

## Latest Four Applications
